...
Program: pong.py
Date: 11/14/2020
Summary:  pong powered by Python 
 """
import turtle
import winsound
...
pen.hideturtle()
pen.goto(0, 260)
pen.write("P1 UP: E, DOWN: C | P2 UP: U, DOWN: N", align="center", font=("Courier", 25, "normal"))
...
while True:
    ...
    if ball.xcor() > 390:
        ...
        pen.write("Player 1: {}  Player 2: {}".format(score_a, score_b), align="center", font=("Courier", 25, "normal")) # Writes the updated score to the Window
